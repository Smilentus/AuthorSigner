# Программа считывает "Подпись" автора и записывает её в первые строчки ...
# ... выбранного файла. 
# Не знаю почему, но почему-то захотелось сделать такую штуку ...
# ... вдруг в будущем нужно будет резко "заклеймировать" парочку файлов
